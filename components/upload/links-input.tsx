...
import { Links } from "@/lib/upload-utils";
...
export const LinksInput: React.FC<Props> = React.memo(({ value, onChange }) => {
  ...
  return (
    <div className="mb-8">
      <Card>
        <CardContent>
          <div className="mb-4">
            <span className="text-xl font-bold text-gray-900">連結</span>
          </div>
